...
<body>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-8">
            ...
            <div class="mb-5">
              <h3 class="h5 d-flex align-items-center mb-4 text-primary"><span class="icon-rocket mr-3"></span>Ingredients</h3>
              <ul class="list-unstyled m-0 p-0">              
                <li class="d-flex align-items-start mb-2"><span class="icon-check_circle mr-2 text-muted"></span><span><c:out value="${recipe[0].title}"/></span></li>
                <li class="d-flex align-items-start mb-2"><span class="icon-check_circle mr-2 text-muted"></span><span><c:out value="${recipe[0].recipe}"/></span></li>
                <li class="d-flex align-items-start mb-2"><span class="icon-check_circle mr-2 text-muted"></span><span><c:out value="${recipe[0].ingredients}"/></span></li>
	...
	<script>
	alert(<c:out value="${recipe[0].title}"/>);
	</script>
